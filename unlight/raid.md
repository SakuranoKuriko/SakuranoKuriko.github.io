...
|种类|HP|合金|魔材|备注|
|-|-|-|-|-|
|[妖精](#fairy)[^图5]|100|<font color=red>无</font>|随机|最简单，因为只有100血|
|[海鲜](#haixian)[^图6]|550/1000/2000|突击|弹头|第二简单|
|[虫](#bug)[^图7]|550/1000/2000|强防|戒指||
|[鱼](#fish)[^图8]|550/1000/2000|防护|手镯||
|[龟](#turtle)[^图9]|1200/6000/12000|防护|手镯|奖励跟鱼相同因此大家都不爱打皮糙肉厚的龟|
|[死兽](#dog)[^图10]|550/3500/6000|强攻|刀身|最难打。|
...
## <span name="fairy" id="fairy">妖精</span>[^图5]
...
## <span name="haixian" id="haixian">海鲜</span>[^图6]
...
## <span name="bug" id="bug">虫</span>[^图7]
...
L2[泰瑞尔](https://w.atwiki.jp/unlight-fbtw/pages/305.html)，M1[死之齿轮](https://w.atwiki.jp/unlight-fbtw/pages/223.html#id_8a5c3e30)。
...
用[里卡穿](#AdvanceFighter)将穿穿换成L2泰瑞尔，卡中距离雷完牌造好剑4之后再送混沌，然后拉近造剑9，造剑9时顺便扔出移2给虫，下回合换泰瑞，剑9会全部被夺走，直接弹。



## <span name="fish" id="fish">鱼</span>[^图8]
...
## <span name="turtle" id="turtle">龟</span>[^图9]
...
## <span name="dog" id="dog">死兽</span>[^图10]
...
1. 给涡BOSS贴上buff(异常状态)，通常必上[39](#buff39) + [狂战士](#buff2x)，虫必上[傀儡](#buffnomovskill)
2. 不断延长刷新buff持续时间
3. 硬揍（按着打）
...
任意开场可以额外抽卡的角色 + M3[噩梦齿轮](https://w.atwiki.jp/unlight-fbtw/pages/223.html#id_8a5c3e30)。
...
攻击阶段 / 近·中距离 / 无1↑ 无1↑ 无1↑ / 自己HP减半(HP减半后的尾数舍去)，本次战斗造成的骰子伤害翻倍。

会先HP减半再计算战斗伤害，1HP时发动这个技能会自杀，不再计算骰子伤害。

攻击阶段 / 全距离 / 无1↑ 无1↑ / ATK+6，对方HP为最大值时攻击2次。
