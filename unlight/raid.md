...
|龟[^图9]|3000/6000/12000|防护|手镯|奖励跟鱼相同因此大家都不爱打皮糙肉厚的龟|
...
指ATK↓9[^buff:ATK↓][^图标:ATK↓]、DEF↓9[^buff:DEF↓][^图标:DEF↓]、MOV↓9[^buff:MOV↓][^图标:MOV↓]（图片没有数值9的版本）
...
打虫必上，让它不能发动移动阶段的技能：捕食获得混沌[^buff:混沌][^图标:混沌]、夺取玩家手牌。
