...
使用R4以上[玛格丽特](https://w.atwiki.jp/unlight-fbtw/pages/56.html)/[复活玛格丽特](https://w.atwiki.jp/unlight-fbtw/pages/413.html)，L5/R1以上[泰瑞尔](https://w.atwiki.jp/unlight-fbtw/pages/305.html)，任意快速使对方获得ATK↓[^buff:ATK↓][^图标:ATK↓]、DEF↓[^buff:DEF↓][^图标:DEF↓]、MOV↓[^buff:MOV↓][^图标:MOV↓]状态的角色（这三个buff只要是下降，数值是多少都可以）（也可以用怪物卡）。

**玛格丽特** *【[Ex末日幻影](https://w.atwiki.jp/unlight-fbtw/pages/56.html#id_0b66e462)】* 移动阶段 / 全距离 / 剑1↑ 枪1↑ / 根据移动后的距离使对方获得状态异常。

非Ex的末日幻影不能出移动卡，嫌麻烦就用复活吧。

移动到远距离即可使对方获得<font color=red>狂战士</font>[^buff:狂][^图标:狂]。

**无论如何都不要移动到近距离使对方获得<font color=red>恐惧</font>[^buff:恐惧][^图标:恐惧]。**
...
[^图标:狂]: ![buff_狂战士](img/buff_狂战士.gif)
